...
export const APIKEY_PROVIDERS = {
  ...
  greennode: { id: "greennode", alias: "gn", name: "GreenNode", icon: "cloud", color: "#00B04F", textIcon: "GN", website: "https://aiplatform.console.vngcloud.vn", notice: { apiKeyUrl: "https://aiplatform.console.vngcloud.vn/keys" }, serviceKinds: ["llm"] },
